...
contract ArbNFTAstronautClub is ERC721, Ownable, Pausable {
    ...
    function randomOne(uint256 tokenId) internal view returns (Arb memory) {
        ...
        arb.characterName = genCharacter(
            random(abi.encodePacked(ra1, (150000 - tokenId).toString()))
        )[1];
        arb.spaceshipName = genSpaceship(
            random(abi.encodePacked(rb1, (150000 - tokenId).toString()))
        )[1];
        return arb;
    }
    ...
    function getTraits(Arb memory arb) internal view returns (string memory) {
        ...
        o = string(
            abi.encodePacked(o, tr6, uint256(arb.clothesLineColor).toString())
        );
    ...
    function genImgSVG(uint256 tokenId) public view returns (string memory) {
        ...
        string memory output = string(
            abi.encodePacked(z[0], bg1, genPlanet(tokenId)[0], bg2)
        );
        output = string(
            abi.encodePacked(
                output,
                bg1,
                genSpaceship(random(abi.encodePacked(rb1, tokenId.toString())))[
                    0
                ],
                bg2
            )
        ...
        output = string(
            abi.encodePacked(
                ...
                z[5],
                z[6],
                genCharacter(random(abi.encodePacked(ra1, tokenId.toString())))[
                    0
                ],
                color[arb.faceColor],
                sp1,
