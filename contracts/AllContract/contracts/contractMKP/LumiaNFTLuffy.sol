...
contract LumiaNFTLuffy is ERC721, Ownable, Pausable {
    constructor() ERC721("LumiaNFT Luffy OnePiece", "LumiaNFT") Ownable() {}
    ...
    string private co1 = ", ";
    string private rl1 = '{"name": "LumiaNFT #';
    string private rl3 = '"}';
    ...
    function randomOne(uint256 tokenId) internal view returns (Arb memory) {
        ...
        uint256 seed = random(abi.encodePacked("LumiaNFT", tokenId.toString()));
        Arb memory arb;
